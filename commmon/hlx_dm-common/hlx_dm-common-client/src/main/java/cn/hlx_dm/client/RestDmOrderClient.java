...
import cn.hlx_dm.fallback.DmOrderClientFallBack;
...
*/
@FeignClient(name = "hlx_dm-order-provider", configuration = DmConfiguration.class, fallback = DmOrderClientFallBack.class)
